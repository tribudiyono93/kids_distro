...
<!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12"> 
                            <a href="<?php echo site_url();?>index.php/Stock_controller" class="btn btn-primary"><i class="fa fa-reply"></i> Kembali</a> 
                            <div class="box" style="margin-top: 10px">
                                <div class="box-header">
                                    <h3 class="box-title">Stok Produk</h3>
                                    <div class="box-tools">
                                        <div class="input-group">
                                            <input type="text" name="table_search" class="form-control input-sm pull-right" style="width: 150px;" placeholder="Ukuran"/>
