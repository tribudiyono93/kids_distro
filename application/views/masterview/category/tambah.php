                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                ...
                                <!-- form start -->
                                <form role="form" action="<?php echo base_url('index.php/Category_controller/save');?>" method="POST">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="product_category_name" class="form-control" placeholder="Nama Kategori"/>
                                                    </div>
                                                </div> 
                                                <br /> <br /> 
                                                <div class="form-group">
